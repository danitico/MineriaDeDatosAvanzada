...
Se puede observar que si no se aplican técnicas de balanceo sobre el dataset (el modelo raw),
la capacidad de poder clasificar bien las instancias de la clase positiva (la clase minoritaria) es pésima.

Write a short comment on the main conclusions obtained throughout the
experimental analysis. Focus on the most interesting behavior achieved
by the methods applied, observing whether there are some special
