...
cm.undersampling <- test_model(testData, model.undersampling, "US")
...
cm.oversampling <- test_model(testData, model.oversampling, "OS")
...
#Final Comments Hope you enjoyed this tutorial about Imbalanced
